                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input
                                            value="@formatPhone($user->phone)" type="text" name="phone" id="phone" placeholder="Enter Your Phone" class="form-control">
                                        <p></p>
                                    </div>
                                    ...
                                    <div class="mb-3">                                    
                                        ...
                                        <select name="country_id" id="country_id" class="form-control">
                                            ...
                                            @if ($countries->isNotEmpty())
                                                ...
                                                <option {{ !empty($address) && $address->country_id == $country->id ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name }}</option> @endforeach
                                             @endif   
                                        </select>
                                        <p></p>
                                    </div>

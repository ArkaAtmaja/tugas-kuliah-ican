                 ...
                 <div class="col-md-7">
                     <div class="bg-light right">
                         ...
                         @if ($product->compare_price > 0)
                             <h2 class="price text-secondary"><del>@rupiah($product->compare_price)</del></h2>
                         @endif

                         <h2 class="price ">@rupiah($product->price)</h2>
 ...
 @section('customJs')
     <script type="text/javascript">
         $("#productRatingForm").submit(function(event) {
             ...
             // Proceed with AJAX submission if the user is logged in
             $.ajax({
